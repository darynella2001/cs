...
save_btn = Button(frame, bg="#519487", fg="white", font=btn_font, text="Save", width=13, height=1, command=save_config).place(relx=0.01, rely=0.01)
import_btn = Button(frame, bg="#519487", fg="white", font=btn_font, text="Import", width=13, height=1,command=import_audit).place(relx=0.01, rely=0.065)
download_btn = Button(frame, bg="#519487", fg="white", font=btn_font, text="Download", width=13, height=1,command=extract_file).place(relx=0.01, rely=0.12)
select_all_btn = Button(frame, bg="#519487", fg="white", font=btn_font, text="Select All", width=13, height=1,command=select_all).place(relx=0.01, rely=0.175)
deselect_all_btn = Button(frame, bg="#519487", fg="white", font=btn_font, text="Deselect All", width=13, height=1,command=deselect_all).place(relx=0.01, rely=0.229)
exit_btn = Button(frame, bg="#519487", fg="white", font=btn_font, text="Exit", width=13, height=1,command=main.quit).place(relx=0.01, rely=0.284)
global e
e = Entry(frame, bg="#519487", font=btn_font, width=25, textvariable=querry).place(relx=0.2, rely=0.04)
find_btn = Button(frame, bg="#519487", fg="white", font=btn_font, text="Find", width=8, height=1,command=find).place(relx=0.41, rely=0.035)
check_btn = Button(frame, bg="#519487", fg="white", font=btn_font, text="Check", width=8, height=1,command=check).place(relx=0.485, rely=0.035)

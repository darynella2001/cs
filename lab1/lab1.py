...
save_btn = Button(frame, bg="#519487", fg="white", font=btn_font, text="Save", width=8, height=1, command=save_config).place(relx=0.01, rely=0.01)
import_btn = Button(frame, bg="#519487", fg="white", font=btn_font, text="Import", width=8, height=1,command=import_audit).place(relx=0.01, rely=0.065)
download_btn = Button(frame, bg="#519487", fg="white", font=btn_font, text="Download", width=8, height=1,command=extract_file).place(relx=0.01, rely=0.12)
exit_btn = Button(frame, bg="#519487", fg="white", font=btn_font, text="Exit", width=8, height=1,command=main.quit).place(relx=0.01, rely=0.175)
